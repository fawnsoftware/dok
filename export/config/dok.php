...
return [
    ...
    'markdown' => [
        ...
        */
        ...
        'components' => [
            'note' => ['template' => 'components.hint.hint'],
            'tip' => ['template' => 'components.hint.hint'],
            'important' => ['template' => 'components.hint.hint'],
            'caution' => ['template' => 'components.hint.hint'],
            'warning' => ['template' => 'components.hint.hint'],
    ...
    */
    ...
    'resources' => [
        'dok-docs' => [
            'source' => 'github',
            'repo' => 'jonkaric/dok-docs',
            'branch' => 'main',
            'content' => ['dok', 'tok', 'bok'],
            'token' => env('GITHUB_SYNC'),
        ],
        'documentation_v2_content' => [
            'repo' => 'jonkaric/dok-docs',
            'branch' => 'main',
            'branch' => 'main',
            'token' => env('GITHUB_SYNC_TOKEN_DOK_DOCS'),
        ],
        'documentation_v2_all' => [
            'repo' => 'fawnsoftware/dok-docs',
            'branch' => 'main',
            'token' => env('GITHUB_SYNC_TOKEN_DOK_DOCS'),
        ],
    ],
